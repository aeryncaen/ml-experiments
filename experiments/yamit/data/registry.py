...
DATASETS: list[Dataset] = [
    ...
    # =========================================================================
    # CODE — Stack v2 (stage 1, partially stage 2/3)
    # =========================================================================
    Dataset(
    ...
    Dataset(
        ...
        text_column="content",
        category=Category.CODE,
        stage_weights={1: 0.013},
    ),
    Dataset(
        name="stack-v2-JavaScript",
        hf_path="bigcode/the-stack-v2",
    ...
    Dataset(
        ...
        text_column="content",
        category=Category.CODE,
        stage_weights={1: 0.018},
    ),
    Dataset(
        name="stack-v2-C-Sharp",
        hf_path="bigcode/the-stack-v2",
        hf_subset="C#",
        text_column="content",
        category=Category.CODE,
        stage_weights={1: 0.006},
    ),
    Dataset(
        name="stack-v2-PHP",
        hf_path="bigcode/the-stack-v2",
    ...
    Dataset(
        name="stack-v2-TypeScript",
        hf_path="bigcode/the-stack-v2",
        hf_subset="TypeScript",
        text_column="content",
        category=Category.CODE,
        stage_weights={1: 0.003, 2: 0.003},
    ),
    Dataset(
        name="stack-v2-Swift",
        hf_path="bigcode/the-stack-v2",
    ...
    Dataset(
        ...
        text_column="content",
        category=Category.CODE,
        stage_weights={1: 0.0008, 2: 0.0002},
    ),
    Dataset(
        name="stack-v2-Markdown",
        hf_path="bigcode/the-stack-v2",
        hf_subset="Markdown",
        text_column="content",
        category=Category.CODE,
        stage_weights={1: 0.005},
    ),
    Dataset(
        name="stack-v2-HTML",
        hf_path="bigcode/the-stack-v2",
        ...
        text_column="content",
        category=Category.CODE,
        stage_weights={1: 0.006, 2: 0.00614},
    ),
    Dataset(
        name="stack-v2-Rust",
        hf_path="bigcode/the-stack-v2",
        ...
        text_column="content",
        category=Category.CODE,
        stage_weights={1: 0.0008, 2: 0.0008},
    ),
    Dataset(
        name="stack-v2-Go",
        hf_path="bigcode/the-stack-v2",
        ...
        text_column="content",
        category=Category.CODE,
        stage_weights={1: 0.0005, 2: 0.0005},
    ),
    Dataset(
        name="stack-v2-Shell",
        hf_path="bigcode/the-stack-v2",
        ...
        text_column="content",
        category=Category.CODE,
        stage_weights={1: 0.0007, 2: 0.0001},
    ),
    # =========================================================================
    ...
    # =========================================================================
    # CODE — Stack-Edu (stage 2+ replacements for some Stack v2 languages)
    # =========================================================================
    Dataset(
    ...
    Dataset(
        ...
        text_column="text",
        category=Category.CODE,
        stage_weights={2: 0.01725, 3: 0.018},
    ),
    Dataset(
        ...
        text_column="text",
        category=Category.CODE,
        stage_weights={2: 0.01625, 3: 0.018},
    ),
    Dataset(
        name="stack-edu-C",
        hf_path="HuggingFaceTB/stack-edu",
    ...
    Dataset(
        ...
        text_column="text",
        category=Category.CODE,
        stage_weights={2: 0.018, 3: 0.044},
    ),
    Dataset(
        name="stack-edu-C-Sharp",
        hf_path="HuggingFaceTB/stack-edu",
        hf_subset="C#",
        text_column="text",
        category=Category.CODE,
        stage_weights={2: 0.006, 3: 0.006},
    ),
    Dataset(
        name="stack-edu-PHP",
        hf_path="HuggingFaceTB/stack-edu",
    ...
    Dataset(
        ...
        text_column="text",
        category=Category.CODE,
        stage_weights={2: 0.00611, 3: 0.005},
    ),
    Dataset(
        name="stack-edu-HTML",
        hf_path="HuggingFaceTB/stack-edu",
