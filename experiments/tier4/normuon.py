# NorMuon optimizer — from https://github.com/zichongli5/NorMuon (MIT License)
# Muon + per-row adaptive scaling via second-moment normalization
import torch
...
class SingleDeviceNorMuonWithAuxAdam(torch.optim.Optimizer):
    """
    Non-distributed NorMuon+AdamW combo. Pass param_groups with use_muon=True/False.

    NorMuon groups: params, lr, momentum, beta2, weight_decay, use_muon
