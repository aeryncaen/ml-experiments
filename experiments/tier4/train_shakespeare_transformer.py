...
def main() -> None:
    ...
    p.add_argument("--geo-init-method", type=str, choices=["bucket", "kl_bucket", "kl_bucket_mtp", "eig"], default="kl_bucket")
    p.add_argument("--geo-init-mtp-weights", type=str, default="1.0,0.5,0.25")
    p.add_argument("--geo-init-blend", type=float, default=0.75)
    ...
    p.add_argument("--geo-attn-corr-blend", type=float, default=0.1)
    p.add_argument("--geo-attn-corr-rank", type=int, default=8)
    ...
    p.add_argument("--geo-embed-grad-rank", type=int, default=1)
    p.add_argument("--geo-embed-grad-perp-init", type=float, default=0.0)
    p.add_argument("--geo-embed-grad-hold-steps", type=int, default=225)
    p.add_argument("--geo-embed-grad-ramp-steps", type=int, default=75)
