...
def main():
    ...
    for run in range(args.runs):
        ...
        for mt in model_types:
            ...
            # RippleClassifierND in 2D/3D mode expects spatial input, not flattened
            # In 1D mode, ripple needs flattened 1D sequence input
            model_flatten = flatten and not (mt == 'ripple' and (args.mode_2d or args.mode_3d))
